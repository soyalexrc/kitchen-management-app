...
const palettes = {
    ...
    "light": ['hsla(203, 64%, 48%, 1)','hsla(240, 58%, 25%, 0)','hsla(240, 58%, 25%, 0.25)','hsla(240, 58%, 25%, 0.5)','hsla(240, 58%, 25%, 0.75)','hsla(240, 58%, 25%, 1)','hsla(240, 58%, 28%, 1)','hsla(240, 58%, 31%, 1)','hsla(240, 58%, 33%, 1)','hsla(240, 58%, 36%, 1)','hsla(240, 58%, 39%, 1)','hsla(240, 58%, 42%, 1)','hsla(240, 58%, 44%, 1)','hsla(240, 58%, 47%, 1)','hsla(240, 58%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 10%, 1)','hsla(0, 14%, 10%, 0.75)','hsla(0, 14%, 10%, 0.5)','hsla(0, 14%, 10%, 0.25)','hsla(0, 14%, 10%, 0)','hsla(203, 64%, 62%, 1)']
    ,
    "dark": ['hsla(203, 64%, 57%, 1)','hsla(240, 57%, 12%, 0)','hsla(240, 57%, 12%, 0.25)','hsla(240, 57%, 12%, 0.5)','hsla(240, 57%, 12%, 0.75)','hsla(240, 58%, 12%, 1)','hsla(240, 58%, 16%, 1)','hsla(240, 58%, 20%, 1)','hsla(240, 58%, 25%, 1)','hsla(240, 58%, 29%, 1)','hsla(240, 58%, 33%, 1)','hsla(240, 58%, 37%, 1)','hsla(240, 58%, 42%, 1)','hsla(240, 58%, 46%, 1)','hsla(240, 58%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(203, 64%, 43%, 1)']
    ,
    "light_accent": ['hsla(240, 58%, 33%, 1)','hsla(203, 64%, 40%, 0)','hsla(203, 64%, 40%, 0.25)','hsla(203, 64%, 40%, 0.5)','hsla(203, 64%, 40%, 0.75)','hsla(203, 64%, 40%, 1)','hsla(203, 64%, 43%, 1)','hsla(203, 64%, 46%, 1)','hsla(203, 64%, 48%, 1)','hsla(203, 64%, 51%, 1)','hsla(203, 64%, 54%, 1)','hsla(203, 64%, 57%, 1)','hsla(203, 64%, 59%, 1)','hsla(203, 64%, 62%, 1)','hsla(203, 64%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(240, 58%, 47%, 1)']
    ,
    "dark_accent": ['hsla(240, 58%, 46%, 1)','hsla(203, 64%, 35%, 0)','hsla(203, 64%, 35%, 0.25)','hsla(203, 64%, 35%, 0.5)','hsla(203, 64%, 35%, 0.75)','hsla(203, 64%, 35%, 1)','hsla(203, 64%, 38%, 1)','hsla(203, 64%, 41%, 1)','hsla(203, 64%, 43%, 1)','hsla(203, 64%, 46%, 1)','hsla(203, 64%, 49%, 1)','hsla(203, 64%, 52%, 1)','hsla(203, 64%, 54%, 1)','hsla(203, 64%, 57%, 1)','hsla(203, 64%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(240, 58%, 25%, 1)']
